...
import com.prashanth.spring.boot.jdbc.assignment.OperationsOnOrderDetails;
...
public class SpringJdbcExampleApplication {
	...
	/*
	 * System.out.println("=======notifications=========="); NotificationsData
	 * ntd=container.getBean(NotificationsData.class); System.out.println(ntd);
	 * System.out.println(ntd.getJdbcTemplate()); ntd.addNotificationDetails();
	 */	
 ...
 //   ntd.deleteEmployee(102);
	...
	OperationsOnOrderDetails od=container.getBean(OperationsOnOrderDetails.class);
